<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Job Profile.aspx.cs" Inherits="Homework.Job_Profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script type="text/javascript">
         function validation() {
             var p = document.getElementById('<%=txtjname.ClientID%>');
            if (p.value == "") {
                ...
                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" DataKeyNames="jid" OnRowEditing="grd_RowEditing" OnRowDeleting="grd_RowDeleting" OnRowCancelingEdit="grd_RowCancelingEdit" OnRowUpdating="grd_RowUpdating" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                    <Columns>
                        <asp:TemplateField HeaderText="Profile Name">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtjname1" runat="server" Text='<%#Eval("jname") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
