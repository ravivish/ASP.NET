<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Qualification.aspx.cs" Inherits="Homework.Qualification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script type="text/javascript">
         function validation() {
             var p = document.getElementById('<%=txtqname.ClientID%>');
             if (p.value == "") {
                ...
                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" DataKeyNames="qid" OnRowEditing="grd_RowEditing" OnRowDeleting="grd_RowDeleting" OnRowCancelingEdit="grd_RowCancelingEdit" OnRowUpdating="grd_RowUpdating" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                    <Columns>
                        <asp:TemplateField HeaderText="Qualification Name">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtqname1" runat="server" Text='<%#Eval("qname") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
